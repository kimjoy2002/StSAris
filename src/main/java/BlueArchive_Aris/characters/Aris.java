...
public class Aris extends CustomPlayer {
    public static final Logger logger = LogManager.getLogger(Aris.class.getName());
    ...
    private static final String ID = DefaultMod.makeID("Tendou_Aris");
    ...
    public static final String[] orbTextures = {
            "BlueArchive_ArisResources/images/char/aris/orb/layer1.png",
            "BlueArchive_ArisResources/images/char/aris/orb/layer2.png",
            "BlueArchive_ArisResources/images/char/aris/orb/layer3.png",
            "BlueArchive_ArisResources/images/char/aris/orb/layer4.png",
            "BlueArchive_ArisResources/images/char/aris/orb/layer5.png",
            "BlueArchive_ArisResources/images/char/aris/orb/layer6.png",
            "BlueArchive_ArisResources/images/char/aris/orb/layer1d.png",
            "BlueArchive_ArisResources/images/char/aris/orb/layer2d.png",
            "BlueArchive_ArisResources/images/char/aris/orb/layer3d.png",
            "BlueArchive_ArisResources/images/char/aris/orb/layer4d.png",
            "BlueArchive_ArisResources/images/char/aris/orb/layer5d.png",};
    ...
    public Aris(String name, PlayerClass setClass) {
        super(name, setClass, orbTextures,
         "BlueArchive_ArisResources/images/char/aris/orb/vfx.png", null,
                new SpineAnimation("BlueArchive_ArisResources/images/char/aris/Aris.atlas",
                        "BlueArchive_ArisResources/images/char/aris/Aris.json", 1f));
        ...
        initializeClass(null, // required call to load textures and setup energy/loadout.
                ...
                DefaultMod.ARIS_SHOULDER_2, // campfire pose
                DefaultMod.ARIS_SHOULDER_1, // another campfire pose
                DefaultMod.ARIS_CORPSE, // dead corpse
        ...
        loadAnimation(
                DefaultMod.ARIS_SKELETON_ATLAS,
                DefaultMod.ARIS_SKELETON_JSON,
                0.9f);
    ...
    public List<CutscenePanel> getCutscenePanels() {
        ...
        if(AbstractDungeon.player.hasRelic("BlueArchive_Hoshino:PeroroRelic")) {
            panels.add(new CutscenePanel("BlueArchive_ArisResources/images/ending/ending_1_1.png"));
            panels.add(new CutscenePanel("BlueArchive_ArisResources/images/ending/ending_2_2.png"));
            panels.add(new CutscenePanel("BlueArchive_ArisResources/images/ending/ending_3_3.png"));
        }
        else {
