...
public class AwakeningSupernova extends AbstractDynamicCard {
    ...
    public static final String ID = DefaultMod.makeID(AwakeningSupernova.class.getSimpleName());
    public static final String IMG = makeCardPath("AwakeningSupernova.png");
