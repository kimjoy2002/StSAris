...
public class EnhancementScroll extends AbstractDynamicCard {
    ...
    public static final String ID = DefaultMod.makeID(EnhancementScroll.class.getSimpleName());
    public static final String IMG = makeCardPath("EnhancementScroll.png");
