...
public class CreatedApotheosis extends AbstractDynamicCard {
    ...
    public static final String ID = DefaultMod.makeID(CreatedApotheosis.class.getSimpleName());
    public static final String IMG = makeCardPath("CreatedApotheosis.png");
