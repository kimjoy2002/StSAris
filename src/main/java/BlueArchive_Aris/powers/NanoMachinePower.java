...
public class NanoMachinePower extends AbstractPower implements CloneablePowerInterface {
    int turn = 1;
    int divide = 1;
    public static final String POWER_ID = DefaultMod.makeID("NanoMachinePower");
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath("NanoMachinePower84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath("NanoMachinePower32.png"));
