...
public class AwakeningSupernovaPower extends AbstractPower implements CloneablePowerInterface {
    public static final String POWER_ID = DefaultMod.makeID("AwakeningSupernovaPower");
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath("AwakeningSupernovaPower84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath("AwakeningSupernovaPower32.png"));
