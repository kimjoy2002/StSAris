...
public class JobWizardPower extends JobPower implements CloneablePowerInterface {
    ...
    public static final String POWER_ID = DefaultMod.makeID(JobWizardPower.class.getSimpleName());
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath("JobWizardPower84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath("JobWizardPower32.png"));
