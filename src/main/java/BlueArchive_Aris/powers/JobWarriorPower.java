...
public class JobWarriorPower extends JobPower implements CloneablePowerInterface {
    ...
    public static final String POWER_ID = DefaultMod.makeID(JobWarriorPower.class.getSimpleName());
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath("JobWarriorPower84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath("JobWarriorPower32.png"));
