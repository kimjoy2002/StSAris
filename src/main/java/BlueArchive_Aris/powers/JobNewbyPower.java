...
public class JobNewbyPower extends JobPower implements CloneablePowerInterface {
    ...
    public static final String POWER_ID = DefaultMod.makeID(JobNewbyPower.class.getSimpleName());
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath("JobNewbyPower84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath("JobNewbyPower32.png"));
