...
public class JobDevilPower extends JobPower implements CloneablePowerInterface {
    ...
    public static final String POWER_ID = DefaultMod.makeID(JobDevilPower.class.getSimpleName());
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath("JobDevilPower84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath("JobDevilPower32.png"));
