...
public class RestoreStrPower extends AbstractPower {
    public static final String POWER_ID = DefaultMod.makeID("RestoreStrPower");
    private static final PowerStrings powerStrings = CardCrawlGame.languagePack.getPowerStrings(POWER_ID);
    public static final String NAME = powerStrings.NAME;
    public static final String[] DESCRIPTIONS = powerStrings.DESCRIPTIONS;
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath("RestoreStrPower84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath("RestoreStrPower32.png"));
    ...
    public void updateDescription() {
        if(ramain_turn == 1) {
            ...
            this.description = DESCRIPTIONS[2] + ramain_turn + DESCRIPTIONS[3] + amount + DESCRIPTIONS[4];
        }
    }
}
