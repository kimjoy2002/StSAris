...
public class ArisTutorial extends FtueTip {
    private static final TutorialStrings tutorialStrings;
    public static final String[] TEXT;
    public static final String[] LABEL;
    private Texture img1 = ImageMaster.loadImage("BlueArchive_ArisResources/images/ui/t1.png");
    private Texture img2 = ImageMaster.loadImage("BlueArchive_ArisResources/images/ui/t2.png");
    ...
    static {
        tutorialStrings = CardCrawlGame.languagePack.getTutorialString("BlueArchive_Aris:ArisTutorial");
