...
public class QuestPatch {
    ...
    public static class acquirePatcher {
    ...
    public static  class reopenPatcher {
        ...
        {
            boolean draft = (boolean)  ReflectionHacks.getPrivate(__instance, CardRewardScreen.class, "draft");
            boolean codex = (boolean)  ReflectionHacks.getPrivate(__instance, CardRewardScreen.class, "codex");
            boolean discovery = (boolean)  ReflectionHacks.getPrivate(__instance, CardRewardScreen.class, "discovery");
            boolean chooseOne = (boolean)  ReflectionHacks.getPrivate(__instance, CardRewardScreen.class, "chooseOne");

            if(!draft && !codex && !discovery && !chooseOne && hasCardSkipQuest()) {
